# 2026 World Baseball Classic — Game List
# For Claude Code: Fetch each game using https://baseballsavant.mlb.com/gf?game_pk=XXXXX
# Add new games as they are completed. Do not fetch games marked Scheduled.

---

## Pool A — Miami, Florida (loanDepot park)

| Date | game_pk | Away | Home | Score | Venue | Status |
|------|---------|------|------|-------|-------|--------|
| 2026-03-06 | 788105 | Nicaragua | Dominican Republic | TBD | loanDepot park | Complete |
| 2026-03-06 | 788110 | Netherlands | Venezuela | TBD | loanDepot park | Complete |
| 2026-03-07 | 788107 | Israel | Venezuela | TBD | loanDepot park | Complete |
...
| 2026-03-07 | 788137 | Panama | Puerto Rico | TBD | Hiram Bithorn Stadium | Complete |
...
## Notes
- Tournament runs March 5–17, 2026
- 47 total games: 10 per pool (40) + 4 Quarterfinals + 2 Semifinals + 1 Final
- Pool play: 5-team round-robin, each team plays 4 games
- Top 2 teams from each pool advance to Quarterfinals
- Quarterfinals: Miami (Pools C/D matchups) and Houston (Pools A/B matchups)
- Semifinals and Final: Miami (loanDepot park)
- Full Statcast tracking confirmed for all 2026 WBC games including bat speed data
- game_pk values sourced from MLB Stats API (sportId=51) verified against Baseball Savant /gf endpoint
- Pool A teams: Dominican Republic, Venezuela, Netherlands, Nicaragua, Israel
- Pool B teams: United States, Brazil, Great Britain, Italy, Mexico
- Pool C teams: Japan, Korea, Chinese Taipei, Australia, Czechia
- Pool D teams: Puerto Rico, Colombia, Cuba, Panama, Canada
